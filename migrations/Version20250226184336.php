 ...
 */
final class Version20250226184336 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE response ADD scores JSON DEFAULT NULL, CHANGE answers answers JSON NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE response DROP scores, CHANGE answers answers LONGTEXT NOT NULL COLLATE `utf8mb4_bin`');
    }
}
